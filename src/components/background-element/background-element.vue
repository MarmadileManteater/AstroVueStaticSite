...
<template>
  ...
  >
    <InvidiousVideoBackground 
      :videoId="videoId"
    />
    <a class='text-white absolute top-2 right-5 z-10 hover:underline cursor-pointer hidden lg:inline' @click="enableGodot">Load <EmojiImage emoji='🤖' />Godot background scene in browser</a>
  </div>
</template>
